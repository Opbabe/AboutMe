  ...
  const experiences = [
    {
      ...
      type: "Onsite",
      achievements: [
        "Researched augmented reality applications for hospital risk analysis and clinical decision support under Dr. Vuthea Chheang.",
        "Built an immersive Apple Vision Pro experience for visualizing patient data and readmission risk.",
        "Supported a project nominated for presentation at IEEE VR 2026, Daegu, South Korea."
      ],
    },
    {
